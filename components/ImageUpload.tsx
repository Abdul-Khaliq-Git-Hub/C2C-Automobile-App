...
const ImageUpload = () => {
  const [images, setImages] = useState(Array(5).fill(null)); // Array of 4 null values initially
  ...
  return (
    <View className="mt-4 p-2">
      ...
      >
        <Text className="text-white text-center">Select Truck Images</Text>
      </TouchableOpacity>

      <View>
        <Text className="m-4 text-base">Selected Photos</Text>
